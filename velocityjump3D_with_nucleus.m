function [is_anchored, anchoring_time, final_position, path, jump_times] = velocityjump3D_with_nucleus(input_time, params, with_anchoring, num_modes, with_plot)
%Created 4 Jan 2016
...
estimated_max_path_length = round(200000*input_time);
...
while time<endtime && ~is_anchored
    ...
    if xpos(1) >=params.Lx/2
        ...
        xpos(1) = (params.Lx - xpos(1))*(with_anchoring<0.5)+(params.Lx/2)*(with_anchoring>0.5);
...
if params.ellipsoid_boundary==1    
	...
	unit_normal = -pos_intersect/params.nuc_radius; %inward pointing normal?
