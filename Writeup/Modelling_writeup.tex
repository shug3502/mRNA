...
\begin{figure*}
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/3SumStats_phi.png}
            \caption[]%
            {{\small Summary statistics as a function of $\phi$.}}    
            \label{fig:3phi}
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.475\textwidth}  
            \centering 
            \includegraphics[width=\textwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/3SumStats_nu.png}
            \caption[]%
            {{\small Summary statistics as a function of $\nu_1$ and $\nu_2$.}}    
            \label{fig:3nu}
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[b]{0.475\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/3SumStats_omega1.png}
            \caption[]%
            {{\small Summary statistics as a function of $\omega_1$.}}    
            \label{fig:3omega1}
        \end{subfigure}
        \quad
        \begin{subfigure}[b]{0.475\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/3SumStats_omega2.png}
            \caption[]%
            {{\small Summary statistics as a function of $\omega_2$.}}    
            \label{fig:3omega2}
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[b]{0.475\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/3SumStats_lambda.png}
            \caption[]%
            {{\small Summary statistics as a function of $\lambda$.}}    
            \label{fig:3lambda}
        \end{subfigure}
        
        \caption{ \small Three summary statistics (MFPT, number of jumps and jump distance) simulated for parameters $\phi=0.58$, $\nu_1=1.16 \mu \text{ms}^{-1}$, $\nu_2=0.8 \mu \text{ms}^{-1}$, $\omega_1=0.42 \text{s}^{-1}$, $\omega_2=0.84 \text{s}^{-1}$, $\lambda=0.11 \text{s}^{-1}$. For each of (\subref{fig:3phi}) to (\subref{fig:3lambda}), we vary a parameter in turn. 
    ...
    \begin{figure*}
        ...
        \caption{The spatial distribution in the $x$ direction of particles simulated for parameters as in Figure \ref{FIG:Sensitivity_analysis}. For each of (\subref{fig:phi}) to (\subref{fig:lambda}), we vary a parameter in turn. 
...
\begin{figure}[h]
 \centering
 \includegraphics[width = 0.5\textwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/Spatial_distn_gamma_008.eps}
...
\begin{figure} 
        ...
        \caption{Distribution of \textit{grk} MCP Dendra in a stage 5 \text{Drosophila} oocyte and surrounding nurse cells. Stage 5 is equivalent to a time point of around $t=25$ hours, assuming \textit{grk} mRNA production begins at stage 2. A logarithmic scale for the colourmap is used in (\subref{fig:bb}).}
...
\begin{figure*} 
        ...
        \caption{Posterior for each parameter in the full model with production approximated via ABC rejection sampling, using $N=500$, $\alpha=0.1$, based on real data from one single image frame. 
