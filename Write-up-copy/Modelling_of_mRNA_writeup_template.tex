...
What is not yet entirely clear are the molecular mechanisms used in the mRNA localization process and why exactly such a variety of transport methods are present.
...
Segmentation of images was performed using Felzenswalb’s algorithm \citep{Felzenswalb2004efficient} after denoising and deconvolution of the images, with coordinates of particles obtained from centroids of appropriately sized segments. 
...
\begin{figure}
        \centering
        \begin{subfigure}[h]{0.95\columnwidth}
                \includegraphics[width=0.85\columnwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/Q_distn_phi.png}
        ...
        ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
          %(or a blank line to force the subfigure onto a new line)
        \begin{subfigure}[h]{0.95\columnwidth}
                \includegraphics[width=0.85\columnwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/Q_distn_nu.png}
        ...
        \end{subfigure}
         ...
         \begin{subfigure}[h]{0.95\columnwidth}
                \includegraphics[width=0.85\columnwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/Q_distn_omega1.png}
    ...
    \begin{subfigure}[h]{0.95\columnwidth}
                \includegraphics[width=0.85\columnwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/Q_distn_omega2.png}
        ...
        ~ 
         ...
         \begin{subfigure}[h]{0.95\columnwidth}
                \includegraphics[width=0.85\columnwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/Q_distn_lambda.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=\columnwidth]{/home/harrison/Documents/mRNA/Figures_for_writeup/Typical_path.png}
...
\vspace{1cm}
\footnotesize The authors would like to acknowedge valuable discussions with Dr S. Filippi and Dr J. Rittscher, in addition to beneficial input from Prof I. Davis.
