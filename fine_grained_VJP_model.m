function [is_anchored, anchoring_time, final_position, path, jump_times] = fine_grained_VJP_model(params)
%based on velocityjump3D_with_nucleus_and_new_BCs.m
%Created 4 Jan 2016
